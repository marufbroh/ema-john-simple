...
const ReviewItems = ({ item }) => {
    ...
    return (
        <div className='flex justify-between items-center border-2 p-2 rounded-lg'>
            ...
            <button className='hover:bg-red-300 rounded-full p-2'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-red-500">
