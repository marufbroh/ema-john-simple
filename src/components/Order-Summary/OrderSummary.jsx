    ...
    return (
        <>
            ...
            <div className='my-12 text-center'>
                <button onClick={() => handleClearCart()} className='btn btn-error mb-6'>Clear Cart <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ml-2">
